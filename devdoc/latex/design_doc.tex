...
%#3 - admonition name  #4 - admonition text
\newcommand{\admonition}[4]{
\begin{table*}[h]
  \colorbox{#1}{
    \parbox{0.96\linewidth}{\textcolor{#2}{\textbf{#3}} #4}
  }
\end{table*}
}
\newcommand{\TODO}[1]{
    \admonition{red!10}{red}{TODO}{#1}
}
\newcommand{\danger}[1]{
  \admonition{red!10}{red}{DANGER}{#1}
}
\newcommand{\note}[1]{\admonition{blue!10}{black}{NOTE}{#1}}
\newcommand{\think}[1]{\admonition{orange!15}{orange}{THINK}{#1}}
% - grids ----------------------------------------------------------------------
%isometric grid
%#1 - tiles per side
\newcommand{\isogrid}[1] {
