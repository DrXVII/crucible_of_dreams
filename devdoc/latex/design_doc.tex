...
\chapter{Overview}
The engine is implemented as a set of modules and functions accessible under the
\codew{\enginenamespace{}} namespace.
\chapter{Graphics}
...
\begin{table}[h]
  ...
  \begin{tabular}{p{0.4\linewidth - 0.5\columnsep} p{0.6\linewidth - 0.5\columnsep}}
